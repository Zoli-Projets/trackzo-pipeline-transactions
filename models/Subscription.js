...
const Subscription = sequelize.define("Subscription", {
  ...
  plan: { type: DataTypes.ENUM("TRIAL", "BASIC", "PRO", "ENTERPRISE"), allowNull: false, defaultValue: "TRIAL" },
  type: { type: DataTypes.ENUM("TRIAL", "PAID", "GIFT"), allowNull: false, defaultValue: "TRIAL" },
